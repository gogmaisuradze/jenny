  ...
  return (
    <div className="min-h-screen bg-[#f6f7f1] text-neutral-800 select-none font-sans overflow-x-hidden" style={{ backgroundImage: "url('/assets/paper_texture.jpg')", backgroundRepeat: "repeat" }}>
      ...
      <main className="pt-24">
          ...
          <div className="w-full grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div id="hero-portrait-container" className="relative w-[80%] aspect-square">
                {/* Calligraphic drawing orbit around Hero image */}
                <svg className="absolute inset-0 w-full h-full animate-[spin_45s_linear_infinite] opacity-50 pointer-events-none select-none" viewBox="0 0 100 100">
                  <path 
        ...
        >
          {/* Calligraphic ornament in empty margin */}
...
const ScrollDrawingAnimation: React.FC = () => {
  ...
  const calculatePath = () => {
    try {
      ...
      // Segment 2: Curve out of loop down to the Directions section ( Dentistry & Dermatology gap)
...
const CalligraphicFloat: React.FC<CalligraphicFloatProps> = ({ top = 20, left, right, delay = 0, reverse = false }) => {
  ...
  return (
    <div 
      ref={containerRef}
      style={style}
      className="pointer-events-none select-none z-0 hidden lg:block opacity-[0.06] text-neutral-800 transition-opacity duration-1000"
    >
      <svg className="w-56 h-auto" viewBox="0 0 100 160" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round">
        ...
        {/* Calligraphic drawing matching reference drawing */}
        <g filter="url(#float-pencil)">
          {/* Overlapping Calligraphic Tooth Crown loops */}
          <path 
          ...
          />
          {/* Spiraling curly loop roots below */}
          <path 
